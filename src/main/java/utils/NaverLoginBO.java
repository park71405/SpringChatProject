...
public class NaverLoginBO {
	...
	// 네이버 로그인 정보
	private final static String NAVER_CLIENT_ID = "ZVsCtV_60QE11eaDVuBk";
	private final static String NAVER_CLIENT_SECRET = "BttZRs0q0w";
	private final static String NAVER_REDIRECT_URI = "/kosa/naver/loginPostNaver.htm";
